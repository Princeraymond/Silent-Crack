...
def banner():
 ...
 _____ ______   ________              ________  ___  ___       _______   ________   _________       
|\   _ \  _   \|\   __  \            |\   ____\|\  \|\  \     |\  ___ \ |\   ___  \|\___   ___\     
\ \  \\\__\ \  \ \  \|\  \           \ \  \___|\ \  \ \  \    \ \   __/|\ \  \\ \  \|___ \  \_|     
 \ \  \\|__| \  \ \   _  _\           \ \_____  \ \  \ \  \    \ \  \_|/_\ \  \\ \  \   \ \  \      
  \ \  \    \ \  \ \  \\  \| ___       \|____|\  \ \  \ \  \____\ \  \_|\ \ \  \\ \  \   \ \  \     
   \ \__\    \ \__\ \__\\ _\|\__\        ____\_\  \ \__\ \_______\ \_______\ \__\\ \__\   \ \__\    
    \|__|     \|__|\|__|\|__\|__|       |\_________\|__|\|_______|\|_______|\|__| \|__|    \|__|    
                                        \|_________|                                                
...
def dump_massal():
	...
	if pilih in ['1','01']:
		...
		print(x+'['+h+''+x+'] ENTER LIMIT ID TOTAL [20]')
		try:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					cetak(nel(statusok1, title='HAPPY YOUR ACCOUNT OK'))
					ok+=1
					break
					...
					try:
						...
						tem=teman[0].split('(')
						temm=tem[1].split(')')
						infoakun+= (f"[bold blue][√] YEAR : {YEAR[0]}[/blue]\n")
					except:
						infoakun+= (f"[bold blue][√] YEAR : - [/blue]\n")
					try:
						...
						tahu=(len(tah)-1)
						tahun=tah[tahu]
						infoakun+= (f"[bold blue][√] YEAR : {tahun} [/blue]\n")
					except:
						infoakun+= (f"[bold blue][√] YEAR : -  [/blue]\n")
